...
| ID | Email                             |
| -- | --------------------------------- |
| 1  | ashish17zope@gmail.com |
| 1  | ashish17zope@gmail.com |
| 2  | zope17ashish@gmail.com |
| 3  | ashish17zope@gmail.com |
| 4  | sunil17zope@gmail.com |
...
Sample rows are assumed in the Customers and Orders tables for this example.
...
Sample rows are assumed in the Orders table for this example.
...
Sample rows are assumed in the Product table for this example.
...
Sample rows are assumed in the Sales table for this example.
...
Sample rows are assumed in the Orders and Product tables for this example.
...
Sample rows are assumed in the LoginHistory table for this example.
...
Sample rows are assumed in the Users table for this example.
...
Sample rows are assumed in the Product and Orders tables for this example.
