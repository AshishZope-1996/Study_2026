...
<b class="line" style="color:#1C4980;font-weight:bold;">1. Write a Query to Find Duplicate Rows in a Table</b>


<div style="display:flex;justify-content:space-between;">
    <b style="color:#1C4980;">
...
<b class="line">1. Write a Query to Find Duplicate Rows in a Table</b>